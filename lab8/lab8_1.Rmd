...
The data is untidy because it does not meet the very first two requirements. Income being grouped into different variables when it could just be one. Column names 
